 ...
 */
export const TOOLSETS = ["core", "ui", "telemetry", "plugin-dev", "vault", "devtools", "authoring"];
/**
 ...
 */
export const DEFAULT_TOOLSETS = ["core", "ui", "telemetry", "plugin-dev"];
export const TOOLSET_DESCRIPTIONS = {
...
export function isToolset(value) {
  return TOOLSETS.includes(value);
}
/**
 ...
 */
export function parseToolsets(spec) {
