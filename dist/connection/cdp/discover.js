 ...
 */
export function parseObsidianTitle(title) {
...
export function obsidianWindows(targets) {
...
export async function fetchTargets(cdpUrl, timeoutMs = 3000) {
...
export async function probeCdp(cdpUrl, timeoutMs = 2000) {
  const base = cdpUrl.replace(/\/+$/, "");
  try {
